...
//     return (
//         <section className=" bg-[#030005] relative overflow-hidden w-full sm:py-2">

//             {/* AMBIENT BACKGROUND GLOWS */}
//             <div className="absolute top-1/2 left-[-10%] w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] bg-blue-600/5 rounded-full blur-[150px] pointer-events-none" />
//             <div className="absolute bottom-0 right-[-10%] w-[250px] sm:w-[400px] h-[250px] sm:h-[400px] bg-pink-600/5 rounded-full blur-[120px] pointer-events-none" />
...
//                                 Established December 2012</div>
//                         <h2 className="text-3xl sm:text-5xl md:text-8xl font-black text-white leading-none tracking-tighter uppercase italic mb-6 sm:mb-8">
//                             WHO RUN <br />
...
//                         className="relative"
//                     >
//                         <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 font-bold leading-relaxed italic border-l-4 border-blue-600 pl-4 sm:pl-10 select-none">
...
//                 {/* MAIN CONTENT GRID */}
//                 <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-16 mb-16 sm:mb-32">
...
//                                         TCCL has expanded its presence across Tamil Nadu, Andhra Pradesh, and Karnataka with a State-of-the-Art Digital Head End                                    </p>
//                                 </div>
//                             </div>
//                         </div>
//                     </motion.div>
...
//                     whileInView={{ opacity: 1, y: 0 }}
//                     viewport={{ once: true }}
//                     className="relative rounded-[2rem] sm:rounded-[5rem] overflow-hidden bg-gradient-to-br from-[#050510] to-[#030005] border border-white/10 p-6 sm:p-12 lg:p-24 shadow-3xl group"
//                 >
...
//                     <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-20 items-center relative z-10">
//                         <div>
...
//                                 The Way Forward
//                             </div>
//                             <h3 className="text-2xl sm:text-4xl md:text-6xl font-black text-white leading-tight tracking-tighter uppercase italic mb-6 sm:mb-10">
//                                 BEYOND THE <br />
//                                 <span className="text-[#1a89e5]">HORIZON</span>
//                             </h3>
//                             <p className="text-base sm:text-lg lg:text-lg text-gray-400 font-semibold leading-relaxed mb-8 sm:mb-12 italic border-l-2 border-pink-500 pl-4 sm:pl-8">
...
//                     <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-10 p-6 sm:p-12 rounded-[2rem] sm:rounded-[3.5rem] bg-gradient-to-r from-blue-600/20 to-transparent border border-white/10 backdrop-blur-2xl">
//                         <Wifi size={40} className="text-blue-500 flex-shrink-0 sm:size-[48px]" />
//                         <div>
//                             <h4 className="text-lg sm:text-2xl text-white font-black tracking-tighter uppercase italic">Broadband Service</h4>
//                             <p className="text-gray-500 font-bold text-[10px] uppercase tracking-widest mt-2">High Speed Fiber Backbone</p>
//                         </div>
//                     </div>
//                     <div className="flex flex-col sm:flex-row items-center gap-6 sm:gap-10 p-6 sm:p-12 rounded-[2rem] sm:rounded-[3.5rem] bg-gradient-to-r from-pink-600/20 to-transparent border border-white/10 backdrop-blur-2xl">
//                         <Tv size={40} className="text-pink-500 flex-shrink-0 sm:size-[48px]" />
//                         <div>
//                             <h4 className="text-lg sm:text-2xl text-white font-black tracking-tighter uppercase italic">Digital Cable TV</h4>
...
export const AboutSection = () => {
    return (
        <section className="bg-[#030005] relative overflow-hidden w-full py-2 sm:py-2 md:py-2">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 md:gap-20 items-center mb-12 sm:mb-20 md:mb-32">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 sm:px-6 py-2 rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-400 text-[9px] sm:text-[11px] font-black uppercase tracking-[0.4em] sm:tracking-[0.5em] mb-6 sm:mb-10 shadow-[0_0_20px_rgba(26,137,229,0.2)]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 md:gap-16 mb-12 sm:mb-20 md:mb-32">
                    ...
                    >
                        <div className="prose prose-invert max-w-none">
                            ...
                            <div className="h-px bg-white/5 my-6 sm:my-10 prose prose-invert max-w-none" />
                            <p className="text-base sm:text-lg text-gray-400 leading-relaxed font-semibold">
                                Thamizhaga Cable TV Communication Pvt. Ltd. is a leading Multi System Operator (MSO) in Chennai. Started operations in December 2012, we aim to serve the entire state of Tamil Nadu with the best quality Cable Television experience.
                            </p>
                            <p className="text-base sm:text-lg text-gray-400 leading-relaxed font-semibold">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 pt-6 sm:pt-10">
                            {[
                                ...
                                <div key={i} className="p-6 sm:p-8 rounded-2xl sm:rounded-[2.5rem] bg-white/5 border border-white/10 hover:border-blue-500/50 transition-all group">
                    ...
                    <motion.div
                        ...
                        className="lg:col-span-5"
                    >
                        <div className="relative p-8 sm:p-12 rounded-3xl sm:rounded-[4rem] bg-gradient-to-br from-white/10 to-transparent border border-white/10 backdrop-blur-3xl shadow-3xl overflow-hidden group">
                            <div className="absolute inset-0 bg-gradient-to-br from-blue-600/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-1000" />

                            <div className="relative z-10 space-y-8 sm:space-y-12">
                                <div>
                                    <div className="text-[#1a89e5] font-black text-[10px] sm:text-[11px] uppercase tracking-[0.3em] sm:tracking-[0.4em] mb-3 sm:mb-4 shadow-blue-500/20 drop-shadow-lg">Scale of Presence</div>
                                ...
                                <div className="space-y-4 sm:space-y-6">
                                    <div className="flex items-center gap-3 sm:gap-4">
                                        <div className="w-8 sm:w-10 h-8 sm:h-10 rounded-lg sm:rounded-xl bg-blue-600/20 flex items-center justify-center text-blue-400 flex-shrink-0">
                                    ...
                                    <div className="flex items-center gap-3 sm:gap-4">
                                        <div className="w-8 sm:w-10 h-8 sm:h-10 rounded-lg sm:rounded-xl bg-pink-600/20 flex items-center justify-center text-pink-400 flex-shrink-0">
                                            <CheckCircle2 size={18} className="sm:size-5" />
                                        </div>
