  ...
  const menu = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: 'CAF FORM', href: '/assests/pdf3.pdf' },
      ],
    },
  ]
              ...
              <div key={m.title} className="relative">
                {m.items ? (
                  <>
                    ...
                    >
                      {m.items.map((it) => (
                        <a key={it.title} href={it.href}  rel="noopener noreferrer" className="block px-4 py-2 hover:bg-slate-100">
                          {it.title}
                        </a>
                      ))}
                    </div>
                  ...
                  <a href={m.href}  rel="noopener noreferrer" className="px-2 py-1 font-medium hover:opacity-90">
                    {m.title}
                  </a>
                )}
              </div>
