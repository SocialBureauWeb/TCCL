...
export const HeroSection = () => {
  ...
  return (
    <section className="bg-gradient-to-br from-blue-50 via-white to-blue-100 text-slate-900 py-10 md:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10 md:gap-14">
          ...
          >
            <div className="rounded-2xl overflow-hidden shadow-xl ring-1 ring-blue-200">
              <img
                src="https://img.etimg.com/thumb/width-1200,height-900,imgsize-299586,resizemode-75,msid-110676105/industry/media/entertainment/tv-channel-rates-may-soon-go-up-by-5-8.jpg"
                alt="Customer Support"
          ...
          <motion.div
            ...
            className="space-y-6 order-2 md:order-1"
          >
            <h2 className="text-3xl sm:text-4xl font-bold text-[#1187e6]">
              Standard & High Definition
            </h2>
            ...
            {/* BLUE GLASS CARD */}
            <div className="bg-white/80 backdrop-blur-xl p-6 rounded-2xl shadow-lg border border-blue-200">
              ...
              <div className="mt-5 space-y-4">
                ...
                {/* CUSTOMER SUPPORT */}
                <div className="bg-blue-50 p-4 rounded-xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border border-blue-100">
                  <div className="flex items-start gap-3">
                    <FaHeadset className="text-[#1187e6] text-xl" />
                    <div>
                      <p className="text-sm text-slate-600">Customer Support</p>
                      <p className="font-semibold text-sm sm:text-base">
                        {customerSupport} / {tollFree}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2">
                    <a
                      href={`tel:${customerSupport.replace(/[^0-9]/g, '')}`}
                      className="px-4 py-2 bg-[#1187e6] text-white rounded-md text-sm hover:bg-blue-700 transition"
                    >
                      Call
                    </a>
                    <button
                      onClick={() => copyNumber(customerSupport)}
                      className="px-4 py-2 bg-white border border-blue-200 rounded-md text-sm hover:bg-blue-100 transition"
                    >
                      <FaCopy />
                    </button>
                  </div>
              ...
              {copied && (
                <p className="text-green-600 text-sm mt-3">📋 Number copied!</p>
              )}
            </div>
          </motion.div>
